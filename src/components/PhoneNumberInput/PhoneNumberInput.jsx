...
const PhoneNumberInput = ({
  ...
  return (/*#__PURE__*/
    React.createElement(Box, { className: className, display: "flex", gap: 1, sx: { mt: -0.5 } }, /*#__PURE__*/
    ...
    countryCodesList.map(({ code, country }) => /*#__PURE__*/
    React.createElement(MenuItem, { key: `${code}-${country}`, value: `${code}|${country}` },
    code, " ", /*#__PURE__*/React.createElement("span", { style: { marginLeft: '8px' } }, country)
    )
    )
    ), /*#__PURE__*/
    React.createElement(TextField, {
